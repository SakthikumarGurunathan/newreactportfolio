...
export default function Projects({jp}){
    ...
    <div class="samples" data-aos="fade-up" data-aos-duration="2000">
    <a href="https://nileshopping.netlify.app/" target={"_blank"}><img src="Shopping.png" alt="shopping-img" /></a>
        <div>
            <h1 className="project-title">{jp ? "ショッピングサイト":"Shopping site"}</h1>
            <h4>{jp? "シンプルな通販サイトです" :"This is a simple shopping website"}</h4>
            <h4>{jp?"これは、React ルーターを使用して実装された単一ページ アプリケーションです。":"This is a single page application implemented using React router."}</h4>
            <h4>{jp?"このユーザーでは、製品の詳細を見ることができます。":"In this user can see the details of the products."}</h4>
        </div>
